        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-xl shadow-md p-10">
                <h2 className="text-3xl font-bold mb-3">Shane Carey Gales</h2>
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-xl shadow-md p-6 flex items-center gap-5 hover:shadow-xl transition">
                ...
                <div>
                  <h3 className="text-lg font-bold">Email</h3>
                    <p className="text-gray-600">bastyshane1325@gmail.com</p>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 flex items-center gap-5 hover:shadow-xl transition">
                ...
                <div>
                  ...
                  <p className="text-gray-600">0992 154 7712</p>
                </div>
              </div>
            </div>
          </div>
